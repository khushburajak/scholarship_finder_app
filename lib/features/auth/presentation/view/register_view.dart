...
class RegisterView extends StatelessWidget {
  ...
  final _fnameController = TextEditingController(text: 'khushbu');
  final _lnameController = TextEditingController(text: 'Rajak');
  final _phoneController = TextEditingController(text: '123456789');
  final _usernameController = TextEditingController(text: 'khushbu');
  final _passwordController = TextEditingController(text: 'khushbu12354 ');
